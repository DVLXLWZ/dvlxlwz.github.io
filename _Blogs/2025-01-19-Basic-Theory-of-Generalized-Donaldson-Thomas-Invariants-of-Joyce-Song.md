...
>
Here $\mathcal{Q}(G,T^{G})$ is a set of closed subgroups $Q$ of $T^G$ such that $Q=T^G\cap C(C_G(Q))$ and $F(G,T^{G},Q)\in\mathbb{Q}$ are a system of rational coefficients with a complicated definition  which we will not repeat.
>
