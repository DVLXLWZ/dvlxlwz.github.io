...
This proposition says that a general element $[(\mathfrak{R}, \rho)]$ of $\widetilde{\mathrm{SF}}, \widetilde{\mathrm{SF}}(\mathfrak{F}, \chi, \mathbb{Q})$, whose stabilizer groups $\mathrm{Iso}\_{\mathfrak{R}}(x)$ for $x \in \mathfrak{R}(\mathbb{K})$ are arbitrary affine algebraic $\mathbb{K}$-groups, may be written as a $\mathbb{Q}$-linear combination of elements $[(U \times [\operatorname{Spec} \mathbb{K}/T], \rho)]$ whose stabilizer groups $T$ are of the form $\mathbb{G}\_m^k \times K$ for $k \geq 0$ and $K$ finite abelian. That is, by working in $\widetilde{\mathrm{SF}}, \widetilde{\mathrm{SF}}(\mathfrak{F}, \chi, \mathbb{Q})$, we can treat all stabilizer groups as if they are abelian. Furthermore, although $\widetilde{\mathrm{SF}}, \widetilde{\mathrm{SF}}(\mathfrak{F}, \chi, \mathbb{Q})$ forget information about nonabelian stabilizer groups, they do remember the difference between abelian stabilizer groups of the form $\mathbb{G}\_m^k \times K$ for finite $K$.
